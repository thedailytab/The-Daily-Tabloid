...
def main():
    ...
    # Create secure admin config with hashed pa            "Internet Argues About Something"
        ]
...
def get_image_url(headline):
    """Get relevant image using Picsum Photos (reliable alternative to Unsplash)"""
    # Picsum is more reliable - generates random images
    # Use headline hash to get consistent but varied images
    seed = abs(hash(headline)) % 1000
...
.message-name {font-weight: bold; color: #333; font-size: 1.1em;}
.message-text {margin-top: 15px; line-height: 1.6;}
.delete-btn {background: #c00; color: white; border: none; padding: 8px 15px; border-            "Internet Argues About Something"
        ]
