...
<style>body{font-family:Georgia,serif;background:#f5f5f5;margin:0}nav{background:#333;padding:15px}nav a{color:#fff;text-decoration:none;padding:10px 15px}.logo{color:#c00}.main{max-width:800px;margin:40px auto;background:#fff;padding:40px}h1{color:#c00}</style>
</head><body>
<nav><a href="index.html" class="logo">The Tabloid Times</a><a href="about.html">About</a><a href="contact.html">Contact</a><a href="admin.html">Admin</a></nav>
<div class="main"><h1>About</h1><p>AI-powered satirical news. Nothing is real!</p></div>
</body></html>"""

def make_contact():
    return """<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>Contact</title>
<style>body{font-family:Georgia,serif;background:#f5f5f5;margin:0}nav{background:#333;padding:15px}nav a{color:#fff;text-decoration:none;padding:10px 15px}.logo{color:#c00}.main{max-width:600px;margin:40px auto;background:#fff;padding:40px}input,textarea{width:100%;padding:10px;margin:10px 0;border:1px solid #ddd}button{background:#c00;color:#fff;padding:15px 30px;border:none;cursor:pointer}</style>
</head><body>
<nav><a href="index.html" class="logo">The Tabloid Times</a><a href="about.html">About</a><a href="contact.html">Contact</a><a href="admin.html">Admin</a></nav>
<div class="main"><h1>Contact</h1><div id="msg" style="background:#4CAF50;color:#fff;padding:15px;display:none">Sent!</div>
<form id="f"><input id="n" placeholder="Name" required><input id="e" type="email" placeholder="Email" required><textarea id="m" placeholder="Message" required></textarea><button>Send</button></form></div>
<script>
...
document.getElementById('msg').style.display='block';this.reset();
