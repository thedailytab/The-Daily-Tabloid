...
# GitHub gives us a free token automatically in Actions — no key needed!
...
# Free GitHub Models (pick one — phi-3 is small and funny, llama is bigger)
MODEL = "phi-3-mini-4k-instruct"  # Change to "llama3-70b-8192" for even funnier stories if you want
