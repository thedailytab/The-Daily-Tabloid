...
<style>
body {font-family: Arial Black, Arial, sans-serif; margin: 20px auto; max-width: 900px; background: white;}
h1 {text-align: center; color: red; font-size: 3.5em; text-transform: uppercase; text-shadow: 4px 4px yellow;}
.subtitle {text-align: center; font-size: 1.8em; font-style: italic;}
.article {border-bottom: 6px dashed red; padding: 30px 0; background: lightyellow; margin: 20px 0; border-radius: 15px;}
h2 {color: red; font-size: 2.4em; text-transform: uppercase;}
a {text-decoration: none; color: inherit;}
.date {font-size: 0.9em; color: gray; text-align: right;}
</style>
</head>
<body>
