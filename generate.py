...
# GitHub gives us a free magic token automatically — no key needed!
...
# We use GitHub's free smart brain called "phi-3" (it's funny and good!)
MODEL = "phi-3-mini-4k-instruct"

# Your news key (it's okay to have this — it's free and public)
NEWS_API_KEY = "d26a1d4af82d416d955b4237adae75f6"

# File to remember all old stories
...
print("Your newspaper is ready with GitHub's free AI!")asetext-decoration: none; color: inherit;}
.date {font-size: 0.9em; color: #555; text-align: right;}
</style></head><body>
<h1>THE TABLOID DAILY NEWS</h1>
<p class="subtitle">EXCLUSIVE BOMBSHELLS! OUTRAGEOUS SCANDALS!</p>
...
{articles_html}
<hr style="border: 3px dashed #ff0000;">
<p style="text-align:center; color:#777;">ARCHIVE: Every story saved forever 😈</p>
</body></html>"""
...
print("Your newspaper is ready with GitHub's free AI!")h2 {color: #ff0000; font-size: 2.4em; text-transform: uppercase;}
a {text-decoration: none; color: inherit;}
.date {font-size: 0.9em; color: #555; text-align: right;}
</style></head><body>
<h1>THE TABLOID DAILY NEWS</h1>
...
def generate_satire(headline):
    payload = {
        "messages": [
            {"role": "system", "content": "You are a crazy funny tabloid writer. Make a LONG story (10-15 parts) with ALL CAPS, fake funny quotes, silly conspiracies, and celebrity names. Make people laugh!"},
            {"role": "user", "content": headline}
        ],
        "max_tokens": 2000,
        "temperature": 1.0
...
print("Your newspaper is ready with GitHub's free AI!")x2 {color: #ff0000; font-size: 2.4em; text-transform: uppercase;}
a {text-decoration: none; color: inherit;}
.date {font-size: 0.9em; color: #555; text-align: right;}
</style></head><body>
<h1>THE TABLOID DAILY NEWS</h1>
...
print("Your newspaper is ready with GitHub's free AI!")    # Simple split
    if "TITLE:" in content:
